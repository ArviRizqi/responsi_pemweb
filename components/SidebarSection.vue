  ...
  <div class="card sticky-sidebar">
    <div class="position-sticky">
      <div class="w-full pt-4 relative">
        <img
          src="../assets/img/burung.jpg"
          alt=""
          class="w-[230px] h-[230px] absolute ml-10 -top-28 rounded-2xl shadow-xl"
        />
      </div>

      <div
        class="card-body d-flex flex-column align-items-center text-center mt-24"
      >
        <div class="mt-3">
          <h4>Arvi Rizqi Fadhila</h4>
          <p class="text-secondary mb-1">Junior Web Developer</p>
          <ul class="mt-4">
    ...
    <div class="card">
      <ul class="list-group list-group-flush">
        <li
          class="list-group-item d-flex justify-content-between align-items-center flex-wrap py-3 px-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          <span class=" text-lg font-semibold"><a href="#" class=" text-secondary">https://dummy.com</a></span>
        </li>
        <li
          class="list-group-item d-flex justify-content-between align-items-center flex-wrap py-3 px-4"
        >
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="feather feather-phone mr-2 icon-inline text-success"
          >
            <path
              d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"
            />
          </svg>
          <span class="text-secondary text-lg font-semibold"><span>+62</span> 123 4567 8910</span>
        </li>
        <li
          class="list-group-item d-flex justify-content-between align-items-center flex-wrap py-3 px-4"
        >
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="feather feather-inbox mr-2 icon-inline text-primary"
          >
          ...
          <span class="text-secondary text-lg font-semibold">arvi.rizqi123@gmail.com</span>
        </li>
        <li
          class="list-group-item d-flex justify-content-between align-items-center flex-wrap py-3 px-4"
        >
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="feather feather-map-pin text-danger mr-2 icon-inline"
          >
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
            <circle cx="12" cy="10" r="3" />
          </svg>
          <span class="text-secondary text-lg font-semibold">Yogyakarta, Indonesia</span>
        </li>
      </ul>
    </div>
  </div>
